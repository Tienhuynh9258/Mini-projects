...
function App() {
  ...
  return (
    <> 
	  ...
	  <div className="container my-3">
		  ...
		  <div className="card">
			  <div className="card-body">
				...
				<button onClick={handleAddTodo} className="btn btn-primary" id="addBtn" style={{backgroundColor:'green'}}>
					Add Note
				</button>
			  </div>
		  </div>
		  <hr/>
		  <h1>Your Notes</h1>
      <button onClick={handleClearTodos} className="btn btn-primary" style={{backgroundColor:'red',marginLeft:'20px'}}>
					Clear complete
				</button>
		  <hr/>
      ...
      <TodoList todos={todos} toggleTodo={toggleTodo} deleteTodo={deleteTodo} changeName={changeName}/> 
      </div>
	  </div>
    </>
  )
